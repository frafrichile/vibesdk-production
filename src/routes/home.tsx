                        ...
                        <LayoutGroup>
                                        ...
                                        <motion.div
                                                ...
                                                >
                                                        <textarea
                                                                ...
                                                                name="query"
                                                                placeholder={`Crear ${currentPlaceholderText}`}
                                                                ref={textareaRef}
                                ...
                                {!loading && apps?.length > 5 && (
                                        <div className='flex flex-col items-start max-w-6xl my-24 mx-auto px-4 z-10'>
                                                <h2 className="text-2xl font-medium text-text-secondary/80">Descubre Apps creadas por la comunidad</h2>
                                                <div ref={discoverLinkRef} className="text-md font-light mb-4 text-text-tertiary hover:underline underline-offset-4 select-text cursor-pointer" onClick={() => navigate('/discover')} >Ver todas</div>
                                                <motion.div
                                                        layout
